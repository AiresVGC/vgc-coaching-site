      ...
      <div className="pt-32 max-w-7xl mx-auto space-y-16 px-4 pb-20">
        ...
        <section id="about" className="bg-black/80 p-4 rounded-xl space-y-2">
          ...
          <p className="text-gray-200">
            ...
            Based in Portugal, I’ve consistently ranked top 100 and top 500 on ladder and Pokémon Showdown, and have earned
            Championship Points in Global Challenges. My mission is to bring pro-level insights to everyone through affordable and
            customized coaching.
          </p>
        </section>
