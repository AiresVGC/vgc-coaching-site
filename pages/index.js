...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-white bg-cover bg-center lg:bg-fixed" style={{ backgroundImage: "url('/background.png')" }}>
      {/* Navigation Bar */}
      <nav className="fixed top-0 w-full bg-black/70 z-50 shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center relative">
          ...
          {/* Menu */}
          <div className={`absolute top-full left-0 w-full bg-black/90 flex-col items-center space-y-4 py-4 transition-all duration-300 lg:flex lg:flex-row lg:static lg:bg-transparent lg:space-y-0 lg:space-x-6 lg:py-0 ${isMenuOpen ? 'flex' : 'hidden'}`}>
            <a href="#about" className="hover:text-yellow-400 text-sm font-medium">About</a>
            <a href="#services" className="hover:text-yellow-400 text-sm font-medium">Services</a>
            <a href="#testimonials" className="hover:text-yellow-400 text-sm font-medium">Testimonials</a>
            <a href="#contact" className="hover:text-yellow-400 text-sm font-medium">Contact</a>
          </div>
        </div>
      </nav>

      {/* Page Content */}
      <div className="pt-32 max-w-7xl mx-auto space-y-16 px-6">
        {/* Hero Header */}
        <header className="flex flex-col items-center space-y-4 text-center bg-black/80 p-6 rounded-xl">
        ...
        {/* About Me */}
        <section id="about" className="pt-24 bg-black/80 p-6 rounded-xl">
        ...
        {/* Coaching Services */}
        <section id="services" className="pt-24 bg-black/80 p-6 rounded-xl">
        ...
        {/* Testimonials */}
        <section id="testimonials" className="pt-24 bg-black/80 p-6 rounded-xl">
        ...
        {/* Contact */}
        <section id="contact" className="pt-24 bg-black/80 p-6 rounded-xl">
        ...
        <section className="pt-24 bg-black/80 p-6 rounded-xl mb-16">
